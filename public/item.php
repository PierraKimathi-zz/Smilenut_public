...
<div class="row">
    ...
    <div class="col-md-7">
       <img class="img-responsive" src="../resource/<?php echo display_image($row['image']);?>" alt="">
    ...
    <form action="">
        <div class="form-group">
            <a href="../resource/cart.php?add=<?php echo $row['product_id']; ?>" class="btn btn-primary" value="ADD TO CART"></a>
        </div>
    </form>
